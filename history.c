...
/**
 * write_history - create file or appends to existin file
...
/**
 * build_history_list - add entry to history link list
 * @info: structure containing potential argument maintain
 * @buf: buffer
